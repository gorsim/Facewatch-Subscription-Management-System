<?php
/**
 * Run Migration 024: Add Store-Level Pricing
 */
...
echo "Running Migration 024: Add Store-Level Pricing\n";
echo "================================================\n\n";
...
try {
    ...
    $migrationFile = __DIR__ . '/../database/migrations/024_add_store_level_pricing.sql';
    ...
    echo "Store-level pricing tables created successfully.\n";
